...
define(function(require, exports, module) {
    ...
    //---------- require end -------------
    var TMPL = '<div class="swiper-container tillIMGswiper">\
        <div class="swiper-wrapper" node-name="content"></div>\
        </div>';
    ...
    return function(content, opts) {
        ...
        //-----------------自定义函数-------------
        var custFuncs = {
            initSwiper: function(slideTo) {
                m_tillIMGswiper = new swiper(".tillIMGswiper", {
